        ...
        <div class="card-body">
            <form method="POST" action="{{ route('bovins.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="prixachat" class="form-control @error('prixachat') is-invalid @enderror" 
                               value="{{ old('prixachat') }}" step="0.01" required>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" name="poidachat" class="form-control @error('poidachat') is-invalid @enderror" 
                               value="{{ old('poidachat') }}" step="0.1" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="id_etab" class="form-select @error('id_etab') is-invalid @enderror" required>
                            ...
                            <option value="{{ $etable->id_etab }}" @selected(old('id_etab') == $etable->id_etab)>
                                {{ $etable->nom }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="id_vend" class="form-select @error('id_vend') is-invalid @enderror" required>
                            ...
                            <option value="{{ $vendeur->id_vend }}" @selected(old('id_vend') == $vendeur->id_vend)>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="id_q" class="form-select @error('id_q') is-invalid @enderror" required>
                            ...
                            <option value="{{ $q->id_q }}" @selected(old('id_q') == $q->id_q)>
                                {{ $q->libelle }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('bovins.index') }}" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </div>
